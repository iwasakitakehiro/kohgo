...
<main class="page-shell">
  <section class="sub-visual sub-visual--service04">
    <div class="sub-visual__canvas">
      ...
      <h1 class="sub-visual__title">リモートサービス</h1>
    </div>
  </section>
  ...
  <section class="feature-checklist">
    <div class="inner">
      <div class="feature-checklist__heading">
        <p class="feature-checklist__lead">ご自宅やお仕事場にいながら車の修理・点検や小物の取り付け！</p>
        <h2 class="feature-checklist__title">オートサービス向後はリモートサービス可能！</h2>
  ...
  <section class="service-flow-section step-flow-section">
    <div class="inner">
      ...
      <div class="service-flow step-flow">
