        ...
        <div class="story-showcase__top">
          <div class="story-showcase__lead-block">
            ...
            <div class="story-showcase__lead-text">
              ...
              <p>自動車はとてもたくさんの部品からできている工業製品です。毎日使っているとどこか調子が悪くなってくるものです。</p>
              <p>いざという時にいつでも動く自動車であってほしい。ある意味当然のことですが、この地域の皆様の切なる願いです。</p>
              <p>我々の仕事は、そんな自動車を通して、地域の生活基盤を守る縁の下の力持ちのような、現代地域社会に必要不可欠な役目であると自負しております。</p>
            </div>
          </div>

          <div class="story-showcase__hero" aria-hidden="true">
            <div class="story-showcase__hero-frame"></div>
            <div class="story-showcase__image-blank story-showcase__image-blank--hero"></div>
          </div>
        </div>

        <div class="story-showcase__bottom">
          <div class="story-showcase__gallery" aria-hidden="true">
            <div class="story-showcase__image-blank story-showcase__image-blank--thumb"></div>
            <div class="story-showcase__image-blank story-showcase__image-blank--thumb"></div>
            <div class="story-showcase__image-blank story-showcase__image-blank--thumb"></div>
            <div class="story-showcase__image-blank story-showcase__image-blank--thumb"></div>
          </div>
  ...
  <section class="job-grid-section">
    <div class="inner">
      ...
      <div class="job-grid">
        <article class="job-card">
          <div class="job-card__body">
            ...
            <div class="job-card__image-blank" aria-hidden="true"></div>
      ...
      <div class="support-highlight">
        <p class="support-highlight__watermark" aria-hidden="true">CERTIFICATION SUPPORT</p>
        ...
        <div class="support-highlight__image-blank" aria-hidden="true"></div>
      </div>
    </div>
  </section>
</main>
