    ...
    <div class="inner">
      <div class="job-hero">
        <div class="job-hero__content">
          ...
          <h2 class="job-hero__title">営業・販売（正社員）</h2>
        </div>
        <div class="job-hero__media" aria-hidden="true">
          <div class="job-hero__image-blank">
            <img src="<?= get_template_directory_uri(); ?>/img/recruit/recruit01.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="inner">
      <div class="info-grid">
        ...
        <div class="info-grid__row info-grid__row--multiline">
          ...
          <div class="info-grid__value">
            <p>自動車販売店の営業販売業務を行っていただきます。</p>
            <ul>
              <li>接客対応・事務処理業務</li>
              <li>電話対応・グリーティング（来店されたお客様のご案内等）</li>
              <li>簡単なPC入力(顧客データ管理・ローン審査・伝票作成等)</li>
              <li>店内整理整頓、清掃</li>
              <li>その他、付随する関連業務</li>
            </ul>
            <p class="info-grid__note">※アットホームな職場なので人柄とやる気を重要視します</p>
            <p class="info-grid__note">※経験のない方でも丁寧に指導いたします</p>
          </div>
        </div>
        ...
        <div class="info-grid__row info-grid__row--multiline">
          ...
          <div class="info-grid__value">
            ...
            <p class="info-grid__note">※月給に製造・歩合・交通費(月額5,000円まで)支給あり。</p>
